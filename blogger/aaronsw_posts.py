...
# script name   : aaronsw_posts.py
# description   : crawl from aaronsw and convert to markdown
###############################################################################
...
file_name = "/home/user/journal/news/" + str(year) + "-" + str(month) + "/aaronsw_" + author + "_" + title + ".md"
